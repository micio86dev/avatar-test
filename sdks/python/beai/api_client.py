...
from beai.configuration import Configuration
from beai.api_response import ApiResponse, T as ApiResponseT
import beai.models
from beai import rest
from beai.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(beai.models, klass)
