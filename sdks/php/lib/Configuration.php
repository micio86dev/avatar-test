...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.beai.example/v1';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/0.57.1/PHP';
    ...
    {
        $report  = 'PHP SDK (Beai) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 0.57.1' . PHP_EOL;
        $report .= '    SDK Package Version: 0.57.1' . PHP_EOL;
