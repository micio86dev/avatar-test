...
/**
 * PublicApiUsageShow200ResponseEvaluations Class Doc Comment
 *
 * @category Class
 * @package  Beai
 * @author   OpenAPI Generator team
 ...
 */
class PublicApiUsageShow200ResponseEvaluations implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'public_api_usage_show_200_response_evaluations';
     ...
     * Sets pending
     *
     * @param string $pending 'processing' folded into 'pending' — see class doc, point 2.
     *
     * @return self
     */
