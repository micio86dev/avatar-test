...
/**
 * PublicApiInterviewsStore201Response Class Doc Comment
 *
 * @category Class
 * @package  Beai
 * @author   OpenAPI Generator team
 ...
 */
class PublicApiInterviewsStore201Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'public_api_interviews_store_201_response';
    ...
    protected static $openAPITypes = [
        'expires_at' => 'string',
        'hosted_url' => 'string',
        'interview' => '\Beai\Model\PublicInterview',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('interview', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['interview'] === null) {
            $invalidProperties[] = "'interview' can't be null";
        }
     ...
     * Gets interview
     *
     * @return \Beai\Model\PublicInterview
     */
     ...
     * Sets interview
     *
     * @param \Beai\Model\PublicInterview $interview interview
     *
     * @return self
     */
    public function setInterview($interview)
    {
        if (is_null($interview)) {
            throw new \InvalidArgumentException('non-nullable interview cannot be null');
        }
