...
/**
 * PublicApiUsageShow200ResponseInterviews Class Doc Comment
 *
 * @category Class
 * @package  Beai
 * @author   OpenAPI Generator team
 ...
 */
class PublicApiUsageShow200ResponseInterviews implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'public_api_usage_show_200_response_interviews';
    ...
    protected static $setters = [
        ...
        'pending' => 'setPending',
        'under_evaluation' => 'setUnderEvaluation'
    ];
    ...
    protected static $getters = [
        ...
        'pending' => 'getPending',
        'under_evaluation' => 'getUnderEvaluation'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('under_evaluation', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['under_evaluation'] === null) {
            $invalidProperties[] = "'under_evaluation' can't be null";
        }
     ...
     * Sets in_progress
     *
     * @param int $in_progress in_progress
     *
     * @return self
     */
    ...
    /**
     * Gets under_evaluation
     *
     * @return int
     */
    public function getUnderEvaluation()
    {
        return $this->container['under_evaluation'];
    }

    /**
     * Sets under_evaluation
     *
     * @param int $under_evaluation under_evaluation
     *
     * @return self
     */
    public function setUnderEvaluation($under_evaluation)
    {
        if (is_null($under_evaluation)) {
            throw new \InvalidArgumentException('non-nullable under_evaluation cannot be null');
        }
        $this->container['under_evaluation'] = $under_evaluation;
